public class Programa {
	...
	public static void main(String[] args) {
		// cria uma agencia de nome "Centro" capaz de ter 10 contas
		...
		// faz depositos nas contas e exibe um relatorio
		
		System.out.println();
		System.out.println("Depositando 100 na conta " + nroConta1 + 
						   " e 200 na conta " + nroConta2);
		if (!agCentro.depositar(nroConta1, 100)) {
			System.out.println("    Conta " + nroConta1 + " inexistente!");
		}
		if (!agCentro.depositar(nroConta2, 200)) {
			System.out.println("    Conta " + nroConta2 + " inexistente!");
		}
		...
		// faz transferencia entre as contas
