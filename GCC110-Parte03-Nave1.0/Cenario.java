...
class Cenario
{
    ...
    int tempoUltimoTiro = 0;
    // guarda quando o ultimo inimigo foi morto
    int tempoUltimoInimigoMorto = 0;
    ...
    BufferedImage imgNave;
    BufferedImage imgInimigo;  
    BufferedImage imgMisselNave;
    BufferedImage imgMisselInimigo;    
    BufferedImage imgExplosao;    
     ...
     */
    Cenario(Nave umaNave, Inimigo umInimigo, Placar umPlacar)
    {                      
     ...
     */
    void excluirTiros(ArrayList<Tiro> tirosARemover)
    {
     ...
     */
    boolean colisaoPontoRetangulo(int xi1, int yi1, int xf1, int yf1, int xi2, int yi2, int xf2, int yf2)
    {
        return (
    ...
    {                    
        Font fontePadrao = new Font("Comic Sans MS", Font.PLAIN, 14);
        Font fonteRodape = new Font("default", Font.PLAIN, 10);
         ...
         * @param g componente grafico de desenho
         */
        void desenharMensagensGerais(Graphics g)
        {
         ...
         * @param g componente grafico de desenho
         */
        void desenharInimigo(Graphics g)
        {            
            if (inimigo.estaVivo())
            {
         ...
         * @param g componente grafico de desenho
         */
        void desenharPlacar(Graphics g)
        {
            Dimension tamanho = getSize();
    ...
    class InputHandler implements KeyListener
    {
         ...
         */       
        boolean teclaEstaPressionada(int keyCode)
        {
