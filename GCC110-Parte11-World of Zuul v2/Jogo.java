 ...
 * 
 * @author  Michael Kolling and David J. Barnes (traduzido por Julio Cesar Alves)
...
public class Jogo 
{
    ...
    {
        Ambiente fora, anfiteatro, cantina, laboratorio, escritorio, porao;
        ...
        porao = new Ambiente("porao abaixo da sala de administracao dos computadores");
    ...
    private void imprimirBoasVindas()
    {
        ...
        System.out.println("World of Zuul e um novo jogo de aventura, incrivelmente chato.");
    ...
    private void irParaAmbiente(Comando comando) 
    {
        ...
        Ambiente proximoAmbiente = 
        	ambienteAtual.getAmbiente(direcao); 
